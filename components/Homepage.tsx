  ...
  const pathways = [
    {
      ...
      icon: <Clock size={32} />,
      description:
        "Intensive, immersive experience designed for career changers and recent graduates.",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Flexible evening courses for working professionals balancing career and education.",
      highlights: [
        "Evening classes",
        "Work while studying",
        "Same degree, flexible pace",
      ],
    },
    {
      ...
      description:
        "Foundational courses for students without a technical background to prepare for the program.",
      highlights: [
        "No CS background needed",
        "Summer intensive",
        "Smooth transition to program",
      ],
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "Learn from leading researchers and industry experts who bring cutting-edge knowledge to the classroom.",
    },
    {
      icon: <Code size={40} />,
      title: "Hands-On Learning",
      description:
        "Build real-world projects and applications using modern technologies and industry best practices.",
    },
    {
      icon: <Users size={40} />,
      title: "Career Services",
      description:
        "Dedicated support team to help with resume reviews, interview prep, and job placement.",
    },
    {
      icon: <TrendingUp size={40} />,
      title: "Industry Connections",
      description:
        "Access to top employers in Chicago and beyond through networking events and on-campus recruiting.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge
                variant="outline"
                className="border-white/30 text-white mb-6 px-4 py-2"
              >
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Transform your career with a rigorous computer science education
                from one of the world's leading universities. No prior CS
                experience required.
              </p>
          ...
          <Card className="border-maroon/20 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 bg-card">
            <CardContent className="p-8 lg:p-12 relative overflow-hidden">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
                <div>
                  <Badge className="bg-gradient-to-r from-maroon to-maroon-dark text-white mb-4 shadow-md">
                    Future-Proof Your Career
                  </Badge>
                  <h2 className="mb-6">
                    AI is Creating Opportunities, Not Replacing Them
                  </h2>
                  <p className="text-lg text-muted-foreground mb-6">
                    As AI transforms industries, the demand for skilled computer
                    scientists has never been higher. Our program prepares you
                    to lead AI development, not be replaced by it.
                  </p>
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-start gap-3">
                        <CheckCircle
                          size={20}
                          className="text-maroon mt-1 flex-shrink-0"
                        />
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="bg-maroon text-white mb-4">
              Flexible Paths to Your Degree
            </Badge>
            <h2 className="mb-4">Choose Your Journey</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Whether you're looking to change careers or advance in your
              current role, we have a path designed for you.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-background/90 to-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              A comprehensive educational experience designed to launch
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Quick access to everything you need for a successful academic
              experience.
            </p>
          </div>
            ...
            {[
              {
                ...
                answer:
                  "No! Our Pre-Program track is designed for students without a CS background. You'll take foundational courses during the summer to prepare you for success in the main program.",
              },
              {
                question: "What are the degree requirements?",
                answer:
                  "Students must complete 12-14 courses (depending on track) with a minimum GPA of 3.0. This includes core requirements in algorithms, systems, and a capstone project.",
              },
              {
                question: "What career support is available?",
                answer:
                  "We offer resume reviews, mock interviews, career counseling, on-campus recruiting events, and access to our extensive alumni network. Our career services team works with you from day one.",
              },
              {
                question: "How do I register for classes?",
                answer:
                  "Registration opens each quarter through the student portal. You'll work with your academic advisor to plan your course schedule based on your interests and career goals.",
              },
            ].map((faq, index) => (
